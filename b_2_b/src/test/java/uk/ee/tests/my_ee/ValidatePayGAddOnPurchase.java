 ...
 *
 * modified by prabhu_s on 08/04/16.
 */

@Test(groups = {"Regression"})
public class ValidatePayGAddOnPurchase extends BaseTest{
	...
	public Object[][] getUsers() {
	    ...
	    public void PurchasePayGAddOnSuccessfully(User user) {
	    	myEELogic.buyAddonsPayG(user);
	    }
}
