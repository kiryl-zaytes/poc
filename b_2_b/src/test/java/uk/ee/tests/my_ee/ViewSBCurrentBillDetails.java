...
public class ViewSBCurrentBillDetails extends BaseTest {
	...
	public Object[][] getUsers() {
		return new Object[][] {
			{ "SB", userRepository.findById(7)},
			};
	    }
	    
	    @Test(dataProvider = "testUsers")
	    public void ViewCurrentBillDetailsForSB(String type,User user) {
	    	myEELogic.viewBillDetailsSB(user);
	    }
}
