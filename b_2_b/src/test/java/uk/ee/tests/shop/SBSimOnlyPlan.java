 ...
 * <p>
 * This class is a testing script for Validate SB SimOnly Plan
 */
@Test(groups = {"Regression"})
public class SBSimOnlyPlan extends BaseTest {
    ...
    public void paygSimOnlyAcquisition(final String planType,
        ...
        order.setCapacity("2GB").setOptions(SHOP_OPTIONS.SIM)
				.setBuyFromSection(shopMap.SIMS).setAccount(ACCOUNT.SB)
                .setCalls(CALLS.PHONE).setTermOfUsage(TERMS.MONTH12).setExtras(extras);
        shopLogic.makeSBSimOrder(order, planType, postCode, customerType,
