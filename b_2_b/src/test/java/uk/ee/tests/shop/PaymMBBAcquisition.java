 ...
 * <p>
 * This class is a testing script for Validate PAYM MBB acquisition for new
 * customer.
 */

@Test(groups = {"Regression"})
public class PaymMBBAcquisition extends BaseTest {
    ...
    public Object[][] getUsers() {
        return new Object[][]{{"PAYM", "deliverToHome", "LS116EE", "false",
    ...
    public void mbbToBasketBestPlanSubscribing(final String planType,
        ...
        //osprey-2
        order.setName("4gee-wifi-mini").
                setOptions(SHOP_OPTIONS.MBB).setBuyFromSection(shopMap.PAYM_MBB).setCalls(CALLS.NO_SELECTION)
