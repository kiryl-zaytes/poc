 ...
 * <p>
 * This class is a testing script for Validate RSA PAYG consumer handset
 * acquisition.
 */

@Test(groups = {TEST_GROUP_REGRESSION})
public class RSAPaygPhoneAcquisition extends BaseTest {
    ...
    public Object[][] getUsers() {
        return new Object[][]{{PAYG, DELIVET_TO_HOME, COMMON_POSTCODE, FALSE,
    ...
    public void paymPhoneAcquisition(final String planType,
        ...
        order.setName("lg-k8-lte-payg").setCapacity
				(CAPACITY_64GB).setOptions(SHOP_OPTIONS.PHONE)
                .setBuyFromSection(shopMap.PAYG_PHONES).setCalls(CALLS
