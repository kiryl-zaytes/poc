...
public class Program {
    ...
    /**
     * @param contentRating The contentRating
     */
    @JsonProperty("contentRating")
    ...
    /**
     * @param unscripted The unscripted
     */
    @JsonProperty("unscripted")
    ...
    /**
     * @param syndicated The syndicated
     */
    @JsonProperty("syndicated")
    ...
    /**
     * @return The seriesEpisodeLength
     */
    @JsonProperty("seriesEpisodeLength")
    ...
    /**
     * @param seriesEpisodeLength The seriesEpisodeLength
     */
    @JsonProperty("seriesEpisodeLength")
    ...
    /**
     * @param programStatus The programStatus
     */
    @JsonProperty("programStatus")
